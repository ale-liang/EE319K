...
checkReadyBitCom
	LDR R1, =SSI0_SR_R ;load address of SSIO_SR_R into R1
	LDR R2, [R1]		;load contents of SSIO_SR_R into R2 
	AND R3, R2, #0x10	;check contents of Bit 4
	CMP R3, #0x10
	BEQ checkReadyBitCom
	LDR R2, =DC
	LDR R3, [R2]
	BIC R3, #0x40
	STR R3, [R2]
